...
<div class="container" style="margin-top: 100px;">
    <div class="col-lg-6 col-lg-offset-3 demo">
        <div class="input-group input-group-lg">
            <input type="email" class="form-control" placeholder="输入您注册的电子邮箱" name="email" id="email">
            <span class="input-group-btn">
                <button class="btn btn-lg btn-primary" type="button" id="sub_btn">找回密码</button>
            </span>
        </div>
        <h4 class="text-danger" id="chkmsg"></h4>
    </div>
