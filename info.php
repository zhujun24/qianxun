    ...
    <div class="col-sm-8 col-sm-offset-2">
        <div class="media">
            <a class="pull-left" href="#">
                <img class="media-object" src="upload_images/head_photo/<?php echo $uheader;?>" alt="头像" style="width: 160px;height: 160px;border-radius: 10px;">
            </a>
            ...
            <div class="media-body">
                ...
                <br/>
                <h4 class="media-heading"><?php echo $ptype;?>物品的人邮箱:
                    <strong>&nbsp;&nbsp;<?php echo $uemail;?></strong>
                </h4>
                <br/>
                <h4 class="media-heading">详情：
                    &nbsp;&nbsp;<span style="line-height: 28px;"><?php echo $pdetails;?></span>
                </h4>
                ...
                if (!empty($pimage)) {
                    ...
                    <a href="#" class="thumbnail">
                        <img src="upload_images/<?php echo $pimage;?>" alt="物品图片">
                    </a>
                <?php
                }
                ?>
