$(document).ready(function (){
    ...
    $('#submit').click(function () {
        if(regexEnum.name.test($('#name').val())==true&&regexEnum.id.test($('#id').val())&&regexEnum.password.test($('#password').val())&&($('#password').val()==$('#password2').val())&&regexEnum.phone.test($('#phone').val())&&regexEnum.email.test($('#email').val())&&(regexEnum.qq.test($('#qq').val())||$('#qq').val()=='')) {
